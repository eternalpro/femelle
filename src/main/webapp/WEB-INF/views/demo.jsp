...
<div class="page-header md-shadow-z-1-i navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="${ctx}/resources/mt/img/logo-light.png" alt="logo" class="logo-default"/>
            </a>
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                    ...
                                    <li>
										...
										<span class="photo">
										<img src="${ctx}/resources/mt/img/avatar2.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Lisa Wong </span>
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
										<span class="photo">
										<img src="${ctx}/resources/mt/img/avatar3.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Richard Doe </span>
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
										<span class="photo">
										<img src="${ctx}/resources/mt/img/avatar1.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group btn-group-devided" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-transparent grey-salsa btn-circle btn-sm">
                                        <input type="radio" name="options" class="toggle" id="option3">Month</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-scrollable table-scrollable-borderless">
                                <table class="table table-hover table-light">
                                    ...
                                    <tr>
                                        <td class="fit">
                                            <img class="user-pic" src="${ctx}/resources/mt/img/avatar4.jpg">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fit">
                                            <img class="user-pic" src="${ctx}/resources/mt/img/avatar5.jpg">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fit">
                                            <img class="user-pic" src="${ctx}/resources/mt/img/avatar6.jpg">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fit">
                                            <img class="user-pic" src="${ctx}/resources/mt/img/avatar7.jpg">
                                        </td>
                                        <td>
                            ...
                            <div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0"
                                ...
                                <div class="general-item-list">
                                    <div class="item">
                                        <div class="item-head">
                                            <div class="item-details">
                                                <img class="item-pic" src="${ctx}/resources/mt/img/avatar4.jpg">
                                    ...
                                    <div class="item">
                                        <div class="item-head">
                                            <div class="item-details">
                                                <img class="item-pic" src="${ctx}/resources/mt/img/avatar3.jpg">
                                    ...
                                    <div class="item">
                                        <div class="item-head">
                                            <div class="item-details">
                                                <img class="item-pic" src="${ctx}/resources/mt/img/avatar6.jpg">
                                                <a href="" class="item-name primary-link">Nick Larson</a>
                                    ...
                                    <div class="item">
                                        <div class="item-head">
                                            <div class="item-details">
                                                <img class="item-pic" src="${ctx}/resources/mt/img/avatar7.jpg">
                                                <a href="" class="item-name primary-link">Nick Larson</a>
                                    ...
                                    <div class="item">
                                        <div class="item-head">
                                            <div class="item-details">
                                                <img class="item-pic" src="${ctx}/resources/mt/img/avatar9.jpg">
                                    ...
                                    <div class="item">
                                        <div class="item-head">
                                            <div class="item-details">
                                                <img class="item-pic" src="${ctx}/resources/mt/img/avatar8.jpg">
                                    ...
                                    <div class="item">
                                        <div class="item-head">
                                            <div class="item-details">
                                                <img class="item-pic" src="${ctx}/resources/mt/img/avatar2.jpg">
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <div id="region_statistics_loading">
                                <img src="${ctx}/resources/mt/img/loading.gif" alt="loading"/>
                            </div>
